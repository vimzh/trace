...
run_one cch-2f        cch-2f-plan.jpg
run_one queenmary     queenmary-plan.jpg
run_one met-historic  met-plan-historic.jpg
run_one queenscollege queenscollege-plan.jpg
run_one getty         getty-plan.pdf
run_one psu           psu-plan.pdf
run_one nationalmall  nationalmall-plan.png
run_one bart          bart-plan.pdf
log "STUDY BATCH COMPLETE"
