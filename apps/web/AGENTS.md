...
- Use restrained shadcn buttons with minimal corner radius and preserve Trace's existing visual language.
...
- Use Geist Sans for interface and display text, Doto with round dots (`font-pixel`) for the brand wordmark and page headings, and DM Mono for code, technical values, and monospaced text.
